...
public class CyActivator extends AbstractCyActivator {
	...
	public void start(BundleContext bc) {
		...
		myLayoutProps.setProperty(PREFERRED_MENU, "Apps");
		//myLayoutProps.setProperty(TITLE, "Apply MyLayout");
		...
		ApplyMyLayoutTaskFactory applyLayoutTaskFactory = new ApplyMyLayoutTaskFactory(layoutManager);
